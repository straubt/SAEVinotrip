...
function addressAutocomplete(containerElement, callback, options) {
    ...
    inputElement.addEventListener("input", function(e) {
      ...
      var promise = new Promise((resolve, reject) => {
        ...
        var url = `https://api.geoapify.com/v1/geocode/autocomplete?text=${encodeURIComponent(currentValue)}&limit=5&apiKey=6f4be8388d5b4065b2ef0f3f1fd7c52e`;
  ...
  addressAutocomplete(document.getElementById("autocomplete-container"), (data) => {
    ...
    console.log(data);
    document.getElementById("numero").value = data.properties["housenumber"]
    document.getElementById("rue").value = data.properties["street"]
