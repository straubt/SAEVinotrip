...
<form method="get">
    ...
    <select name="Domaine" id="selector">
        <option value=<?php echo e($selectdomaine); ?>><?php echo e($textDomaine); ?></option>
    ...
    <select name="Participant" id="selector">
        <option value=<?php echo e($selectparticipant); ?>><?php echo e($textParticipant); ?></option>
        <option value="NONE">Aucun filtre</option>
    ...
    <select name="Theme" id="selector">
        <option value=<?php echo e($selecttheme); ?>><?php echo e($textTheme); ?></option>
        <option value="NONE">Aucun filtre</option>
...
<?php /**PATH /home/poulje/SAEVinotrip/SAE/resources/views/lessejours.blade.php ENDPATH**/ ?>