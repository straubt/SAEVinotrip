      ...
      <?php $tripPicture = 'http://51.83.36.122:' . $PORT_SERVEUR_IMG . '/sejours/' . $item->model->photo_sejour; ?>
        <div class="cart-item">
          ...
          <div class="cart-item-details">
            ...
            <select class="cart-item-quantity" id="children" data-item-id="<?php echo e($item->model->id_sejour); ?>" data-price="<?php echo e($item->model->prix_min_individuel_sejour); ?>">
            ...
            <select class="cart-item-quantity" id="nights" data-item-id="<?php echo e($item->model->id_sejour); ?>" data-price="<?php echo e($item->model->prix_min_individuel_sejour); ?>">
